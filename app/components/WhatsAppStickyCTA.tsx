    ...
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50 py-3 md:py-4 px-4">
      <div className="max-w-4xl mx-auto">
        <a
          ...
          className="block w-full bg-primary text-gray-900 px-6 py-4 rounded-lg font-bold text-base md:text-lg hover:bg-green-400 transition shadow-md text-center"
        >
